    ...
    <div id="contact" className="container mx-auto max-w-3xl">
      ...
      <div className="question-wrap mx-8 mt-2">
        <details className="question py-4 border-b border-grey-lighter">
          ...
          <img src="/seating-plan-img.jpg" className="w-full mt-4" loading='lazy' alt="showing the seating plan" />
          <a href="/seating-plan.pdf" className="button button-secondary mt-3 mb-3" target="_blank" rel="noreferrer">View large Seating plan</a>
